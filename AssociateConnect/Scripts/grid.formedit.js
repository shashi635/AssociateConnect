                ...
                function postIt() {
                    ...
                    if (ret[0] && !rp_ge.processing) {
                        ...
                        var ajaxOptions = $.extend({
                            ...
                            //                      ---- editing end
                            //						type: "GET",
                            data: JSON.stringify(postdata), // $.isFunction(rp_ge.serializeEditData) ? rp_ge.serializeEditData(postdata) :  postdata,
                    ...
                    $("#dData", "#" + dtbl + "_2").click(function (e) {
                        ...
                        if (ret[0] && !rp_ge.processing) {
                            ...
                            var ajaxOptions = $.extend({
                                url: rp_ge.url ? rp_ge.url : $($t).jqGrid('getGridParam', 'editurl'),
                                type: "GET", // p.mtype,
                                data: postd, //$.isFunction(p.serializeDelData) ? p.serializeDelData(postd) : postd,
                                complete: function (data, Status) {
                                    if (Status != "success") {
                                        ret[0] = false;
                                        if ($.isFunction(rp_ge.errorTextFormat)) {
